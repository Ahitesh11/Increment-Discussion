...
import { AppStep, EmployeeData, User, UpcomingData } from './types';
...
const App: React.FC = () => {
  ...
  // Compute counts for the sidebar badges
  ...
  const handleLogin = (user: User) => {
    ...
    // Set initial view based on available permissions
  ...
  return (
    ...
    >
      ...
      {activeStep !== AppStep.DASHBOARD && activeStep !== AppStep.RECORDS && activeStep !== AppStep.ADD_NEW && (
        <>
          {(() => {
